  ...
  return (
    <div className="animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <div className="mt-3 space-y-4">
        ...
        <div className="space-y-2">
          <label className={`text-xs font-bold tracking-widest ml-1 transition-colors ${data.accountNumber?.length === 10 ?'text-emerald-600' :'text-gray-400'}`}>
          ...
          <div className="relative group">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
              <span className={`text-[10px] font-bold transition-colors ${data.accountNumber?.length === 10 ?"text-emerald-500" :"text-gray-300"}`}>
