    ...
    <div className="space-y-2">
      ...
      <div className="relative group">
        <input
          ...
          className={`block w-full rounded-xl border-2 bg-gray-50/30 px-4 pr-4 py-4 text-base text-gray-900 shadow-sm transition-all outline-none font-medium placeholder:text-gray-400 placeholder:text-base placeholder:font-medium ${
            error 
