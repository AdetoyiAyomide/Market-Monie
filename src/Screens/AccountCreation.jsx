               ...
               <div className='flex gap-2'>
                  ...
                  <div>
                    ...
                    <div className='flex flex-col gap-2 w-full'>
                        <label htmlFor="lastName" className="">Full Name <span className='text-red-500'>*</span></label>
                ...
                <div className='flex flex-col gap-2 items-start justify-start w-full'>
                    <label htmlFor="phoneNumber" className="">Phone Number <span className='text-red-500'>*</span></label>
                ...
                <div className='flex flex-col gap-3 items-start justify-start w-full'>
                    <label htmlFor="email" className="">Email Address <span className='text-red-500'>*</span></label>
                    <input 
                      type="email" 
                      id="email" 
                      value={email}
                ...
                <div className='flex flex-col gap-3 items-start justify-start w-full'>
                    <label htmlFor="password" className="">Password <span className='text-red-500'>*</span></label>
                ...
                <div className='flex flex-col gap-3 items-start justify-start w-full'>
                    <label htmlFor="confirmPassword" className="">Confirm Password <span className='text-red-500'>*</span></label>
                ...
                <div className='flex text-xs text-slate-500 gap-3 self-start text-center w-full justify-center py-2'>
