            ...
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              <div>
                ...
                <div className="mt-2 relative">
                  <div className="absolute inset-y-0 left-0 bg-slate-200 dark:bg-black dark:border dark:border-slate-200 rounded-l-md flex items-center px-4 pointer-events-none text-gray-500 font-medium sm:text-sm z-10 transition-colors">
                    +234 (0)
                  </div>
                  <input
                    {...register("phone")}
                    type="tel"
                    className="block w-full rounded-lg border-0 py-4 pl-[96px] pr-4 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6 bg-gray-50/50 dark:bg-black dark:text-white dark:placeholder-white"
